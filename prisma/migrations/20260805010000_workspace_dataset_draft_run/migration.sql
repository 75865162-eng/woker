...
ALTER TABLE "WorkspaceDataset" ADD CONSTRAINT "WorkspaceDataset_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE;
ALTER TABLE "WorkspaceDataset" ADD CONSTRAINT "WorkspaceDataset_fileId_fkey" FOREIGN KEY ("fileId") REFERENCES "FileObject"("id") ON DELETE CASCADE;
ALTER TABLE "WorkspaceDataset" ADD CONSTRAINT "WorkspaceDataset_jobId_fkey" FOREIGN KEY ("jobId") REFERENCES "ImportJob"("id") ON DELETE CASCADE;
ALTER TABLE "DraftRun" ADD CONSTRAINT "DraftRun_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE;
ALTER TABLE "DraftRun" ADD CONSTRAINT "DraftRun_datasetId_fkey" FOREIGN KEY ("datasetId") REFERENCES "WorkspaceDataset"("id") ON DELETE SET NULL;
ALTER TABLE "DraftRun" ADD CONSTRAINT "DraftRun_fileId_fkey" FOREIGN KEY ("fileId") REFERENCES "FileObject"("id") ON DELETE SET NULL;
ALTER TABLE "ExportRecord" ADD CONSTRAINT "ExportRecord_draftRunId_fkey" FOREIGN KEY ("draftRunId") REFERENCES "DraftRun"("id") ON DELETE SET NULL;
