...
ALTER TABLE "TeamRosterMember" ADD CONSTRAINT "TeamRosterMember_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE CASCADE;
