...
ALTER TABLE "SellfoxProductDailySnapshot" ADD CONSTRAINT "SellfoxProductDailySnapshot_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "SellfoxStore"("id") ON DELETE CASCADE;
